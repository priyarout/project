...
<h2 class="text-center ">FILL THE PROFILE DETAILS</h2>
<br><br>
                    <form class="form-horizontal" id="profileRegistrationForm" method="POST" action="{{ route('profileRegistration')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <input id="id" type="hidden" class="form-control" name="id" value="{{ Auth::user()->id }} "  >
                                ...
                                <input id="name" type="text" class="form-control" name="name" value="{{ Auth::user()->firstName }}  {{ Auth::user()->lastName }}" readonly >
                        ...
                        <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="text" class="form-control" name="dob" placeholder="MM/DD/YYYY"required>
